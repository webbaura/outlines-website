  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-black py-28">
      ...
      <div className="absolute top-20 inset-x-0 z-10">
        <Marquee
          items={['Outlines', 'Electronic music culture', 'Melbourne']}
          bordered
        />
      </div>
      ...
      <div className="relative z-10 px-6 w-full max-w-[1400px] flex flex-col items-center text-center">
        <div className="hero-line mb-6 sm:mb-8">
          <Image
        ...
        <p className="hero-line text-white/55 text-[10px] sm:text-xs font-[family-name:var(--font-montserrat)] uppercase tracking-[0.4em] mb-5 sm:mb-7 flex items-center gap-3">
          <span aria-hidden="true" className="block h-px w-6 bg-white/30" />
          Melbourne · House music
          <span aria-hidden="true" className="block h-px w-6 bg-white/30" />
        </p>

        <div className="hero-line hero-line-3 mt-9 sm:mt-11 flex flex-col sm:flex-row items-center gap-3">
          <Link
            href="/house-parties"
